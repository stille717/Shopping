...
**
** Created: Thu Sep 17 10:22:01 2015
...
static const char qt_meta_stringdata_order[] = {
    "order\0"
};
...
const QMetaObjectExtraData order::staticMetaObjectExtraData = {
    0,  qt_static_metacall 
};

const QMetaObject order::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_order,
      qt_meta_data_order, &staticMetaObjectExtraData }
};

#ifdef Q_NO_DATA_RELOCATION
const QMetaObject &order::getStaticMetaObject() { return staticMetaObject; }
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_order))
