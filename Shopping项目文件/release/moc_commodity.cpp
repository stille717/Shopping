...
**
** Created: Thu Sep 17 18:55:01 2015
...
static const char qt_meta_stringdata_commodity[] = {
    "commodity\0\0on_pushButton_clicked()\0"
...
const QMetaObjectExtraData commodity::staticMetaObjectExtraData = {
    0,  qt_static_metacall 
};

const QMetaObject commodity::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_commodity,
      qt_meta_data_commodity, &staticMetaObjectExtraData }
};

#ifdef Q_NO_DATA_RELOCATION
const QMetaObject &commodity::getStaticMetaObject() { return staticMetaObject; }
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_commodity))
