...
**
** Created: Sat Sep 5 19:58:17 2015
...
static const char qt_meta_stringdata_ManagerLogin[] = {
    "ManagerLogin\0"
};
...
const QMetaObjectExtraData ManagerLogin::staticMetaObjectExtraData = {
    0,  qt_static_metacall 
};

const QMetaObject ManagerLogin::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_ManagerLogin,
      qt_meta_data_ManagerLogin, &staticMetaObjectExtraData }
};

#ifdef Q_NO_DATA_RELOCATION
const QMetaObject &ManagerLogin::getStaticMetaObject() { return staticMetaObject; }
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_ManagerLogin))
