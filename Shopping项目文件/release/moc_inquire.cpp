...
**
** Created: Thu Sep 17 15:50:34 2015
...
static const char qt_meta_stringdata_inquire[] = {
    "inquire\0\0on_pushButton_clicked()\0"
...
const QMetaObjectExtraData inquire::staticMetaObjectExtraData = {
    0,  qt_static_metacall 
};

const QMetaObject inquire::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_inquire,
      qt_meta_data_inquire, &staticMetaObjectExtraData }
};

#ifdef Q_NO_DATA_RELOCATION
const QMetaObject &inquire::getStaticMetaObject() { return staticMetaObject; }
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_inquire))
